...
const CAST = {
  "northern-lights:sigrun":          { voice: "bf_emma", speed: 1.0 },
  "northern-lights:keiko":           { voice: "af_nicole", speed: 1.02 },
  "northern-lights:pall":            { voice: "am_puck", speed: 1.12 },
  "base-camp:dawa":                  { voice: "hm_omega", speed: 0.98 },
  "base-camp:priya":                 { voice: "hf_alpha", speed: 1.1 },
  "base-camp:elliot":                { voice: "bm_fable", speed: 1.06 },
  "prize-day:verity":                { voice: "bf_emma", speed: 1.02 },
  "prize-day:tom":                   { voice: "am_puck", speed: 1.12 },
  "prize-day:graham":                { voice: "bm_george", speed: 0.98 },
  "chapel-of-rest:celeste":          { voice: "af_nicole", speed: 0.98 },
  "chapel-of-rest:dev":              { voice: "am_puck", speed: 1.14 },
  "chapel-of-rest:antoine":          { voice: "am_fenrir", speed: 0.96 },
  "dead-air:kessi":                  { voice: "af_heart", speed: 1.08 },
  "dead-air:junior":                 { voice: "am_onyx", speed: 0.96 },
  "dead-air:delroy":                 { voice: "bm_fable", speed: 1.14 },
  "deep-six:ines":                   { voice: "pf_dora", speed: 1.06 },
  "deep-six:tobias":                 { voice: "am_fenrir", speed: 1.02 },
  "deep-six:markus":                 { voice: "pm_alex", speed: 1.0 },
  "carbon:beatriz":                  { voice: "pf_dora", speed: 1.04 },
  "carbon:joaquim":                  { voice: "pm_santa", speed: 1.0 },
  "carbon:rafael":                   { voice: "pm_alex", speed: 1.08 },
  "ninth-wave:morven":               { voice: "bf_isabella", speed: 1.08 },
  "ninth-wave:petra":                { voice: "bf_emma", speed: 0.98 },
  "ninth-wave:callum":               { voice: "bm_george", speed: 0.94 },
  "milk-run:sinead":                 { voice: "bf_isabella", speed: 1.06 },
  "milk-run:davy":                   { voice: "am_puck", speed: 1.14 },
  "milk-run:gerry":                  { voice: "bm_george", speed: 0.96 },
  "bunker:stavros":                  { voice: "am_fenrir", speed: 0.98 },
  "bunker:liza":                     { voice: "af_heart", speed: 1.08 },
  "bunker:panos":                    { voice: "bm_fable", speed: 1.1 },
